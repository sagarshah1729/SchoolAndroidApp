package com.app.school.adapter;
...
import com.app.school.activity.modules.sub_modules.SyllabusBySubject;
import com.app.school.bean.Subject;

/**
 * Created by admin on 20/08/16.
 */
public class SubjectAdapter extends RecyclerView.Adapter<SubjectAdapter.ViewSubjectAdapter>
{
    ...
    public SubjectAdapter(ArrayList<Subject> c_subjects, Context c_ctx){
    ...
    class ViewSubjectAdapter extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void onClick(View v) {
            ...
            Intent intent1 = new Intent(this.v_ctx, SyllabusBySubject.class);
